...
class MainWindow(QWidget):
    ...
    def _item_changed(self, value):
        try:
            ...
            QtWidgets.QMessageBox.critical(None, "Неверный ввод", "Пожалуйста, введите число!")
            value.setText("")
    ...
    def on_pushButtonSolve_clicked(self):
        ...
        if len(result) == 0:
            QtWidgets.QMessageBox.critical(None, "Неверный ввод", "Пожалуйста, попробуйте снова!")
        else:
            for state in result:
